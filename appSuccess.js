...
const myMessageText = "الإعلان ده ممكن يفرق معاك لو عندك أي حاجة للبيع، اعرضها على EgyMarket التطبيق بيعتمد على نظام ذكي يوصل منتجك للناس المهتمة فعلاً والتواصل بين البايع والمشتري سهل، وكمان تقدر تضيف فيديو للمنتج وفي وقت قصير ممكن تلاقي نتيجة كويسة https://play.google.com/store/apps/details?id=com.magod.Swap2";

const myUniquePart = "id=com.magod.Swap2";
